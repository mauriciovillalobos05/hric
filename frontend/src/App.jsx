  ...
  const features = [
    {
      ...
      description: "Sophisticated algorithms connect investors with startups based on compatibility, preferences, and success patterns."
    },
    {
      icon: <Shield className="h-8 w-8 text-blue-600" />,
      title: "Secure Document Sharing",
      description: "Enterprise-grade security for pitch decks, financial statements, and confidential business documents."
    },
    {
      icon: <MessageSquare className="h-8 w-8 text-blue-600" />,
      title: "Integrated Communication",
      description: "Built-in messaging, video calls, and collaboration tools for seamless investor-entrepreneur interactions."
    },
    {
      icon: <Calendar className="h-8 w-8 text-blue-600" />,
      title: "Monthly Events",
      description: "Exclusive 'Shark Tank' style pitch events at Hyatt Residence with networking and investment opportunities."
    },
    {
      icon: <TrendingUp className="h-8 w-8 text-blue-600" />,
      title: "Portfolio Analytics",
      description: "Comprehensive tracking and analytics for investments, deal flow, and market insights."
    },
    {
      icon: <FileText className="h-8 w-8 text-blue-600" />,
      title: "Due Diligence Tools",
      description: "AI-powered document analysis and collaborative due diligence workflows for informed decisions."
    }
  ]
  ...
  const testimonials = [
    {
      ...
      content: "HRIC represents the future of investment in Guadalajara's innovation ecosystem. The platform's sophisticated approach to matching investors with entrepreneurs will accelerate our region's economic development.",
      avatar: "RA"
    },
    {
      name: "Maria González",
      role: "Angel Investor & Tech Executive",
      content: "The AI matching system helped me discover three portfolio companies that perfectly aligned with my investment thesis. The quality of entrepreneurs on HRIC is exceptional.",
      avatar: "MG"
    },
    {
      name: "Carlos Mendoza",
      role: "Founder, TechFlow AI",
      content: "Through HRIC, we connected with investors who not only provided capital but became strategic advisors. The platform's focus on relationship quality sets it apart.",
      avatar: "CM"
    }
  ]
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-4 mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Sophisticated technology meets exclusive networking to create Mexico's 
              premier investment ecosystem
            </p>
          </div>
      ...
      <section id="pricing" className="py-24 bg-gradient-to-br from-slate-50 to-blue-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-4 mb-16">
            ...
            <div className="flex justify-center mt-8">
              <div className="bg-white p-1 rounded-lg border">
                <Button
                  variant={selectedUserType === 'investor' ? 'default' : 'ghost'}
                ...
                <Button
                  variant={selectedUserType === 'entrepreneur' ? 'default' : 'ghost'}
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {(selectedUserType === 'investor' ? investorPlans : entrepreneurPlans).map((plan, index) => (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <h2 className="text-4xl font-bold text-gray-900">Monthly Investment Events</h2>
              <p className="text-xl text-gray-600">
                Experience "Shark Tank for Guadalajara" at our exclusive monthly events 
                held at Hyatt Residence. Connect with investors, watch live pitches, 
                and participate in real investment decisions.
              </p>
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <h3 className="font-semibold">Second Thursday Each Month</h3>
                    <p className="text-gray-600">6:30 PM - 8:30 PM at Hyatt Residence Main Lounge</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Connect with 25-50 select investors and entrepreneurs</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">3 carefully selected startups pitch for 20 minutes each</p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-gradient-to-br from-blue-600 to-purple-600 rounded-2xl p-8 text-white">
              ...
              <p className="text-blue-100 mb-6">
                Premium presentation slots for established companies seeking significant investment. 
                45-minute dedicated sessions with professional videography and investor networking.
              </p>
      ...
      <section className="py-24 bg-gradient-to-r from-blue-600 to-purple-600">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-blue-100 mb-8">
            Connect with qualified investors and promising entrepreneurs in Guadalajara's 
            most exclusive investment club.
          </p>
      ...
      <footer className="bg-gray-900 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8">
            <div className="space-y-4">
              ...
              <p className="text-gray-400">
                Hyatt Residence Investment Club - Connecting capital with innovation 
          ...
          <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400">
            <p>&copy; 2025 HRIC - Hyatt Residence Investment Club. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
