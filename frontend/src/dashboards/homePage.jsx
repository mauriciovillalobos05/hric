            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-xl text-gray-600 leading-relaxed">
                  The premier AI-powered investment platform connecting
                  qualified investors with Mexico's most promising startups.
                  Join Guadalajara's exclusive investment community at Hyatt
                  Residence.
                </p>
              </div>
